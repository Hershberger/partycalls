...
\addcontentsline{toc}{section}{\protect\numberline{}Appendix E: Comparing Party Unity Scores to Responsiveness to Party Calls}%
%------------------------------------------------------------------------------%
...
R$^2$% (full model)
& 0.67          & 0.69       & 0.94         & 0.89         \\
% R$^2$ (proj model)        & 0.02          & 0.02       & 0.81         & 0.61         \\
Adj. R$^2$% (full model)
& 0.34          & 0.38       & 0.87         & 0.74         \\
% Adj. R$^2$ (proj model)   & -0.98         & -0.99      & 0.55         & 0.10         \\
