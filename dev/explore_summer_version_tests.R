...
party_calls_95_summer <- code_party_calls_by_congress_number(95)

party_calls_95_winter <- partycalls::code_party_calls_by_congress_number(95,
  chamber = "senate",
  pval_threshold = 0.05, sim_annealing = FALSE, use_new_match_check = FALSE,
  hybrid = FALSE, reassign_flip_flop = FALSE)

length(intersect(party_calls_95_summer$party_calls,
  party_calls_95_winter$party_calls))

length(setdiff(party_calls_95_summer$party_calls,
  party_calls_95_winter$party_calls))

length(setdiff(party_calls_95_winter$party_calls,
  party_calls_95_summer$party_calls))

source("dev/modified_summer_version_tests.R")
party_calls_95_summer_modified <- code_party_calls_by_congress_number(95)

yea_perc <- apply(party_calls_95_summer_modified$votes, 2,
...
partycalls[party_calls_95_summer_modified$party_calls] <- 1
table(lopsided, partycalls)

length(intersect(party_calls_95_summer_modified$party_calls,
  party_calls_95_winter$party_calls))

length(setdiff(party_calls_95_summer_modified$party_calls,
  party_calls_95_winter$party_calls))

length(setdiff(party_calls_95_winter$party_calls,
  party_calls_95_summer_modified$party_calls))
