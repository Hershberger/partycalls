...
pdf(file="plots/who-heeds-figure2-replication_interaction.pdf", ## RENAME
...
#   fm_extremism(x, 0)$coef["ideological_extremism", "Std. Error"])
#
# pdf(file="plots/who-heeds-figure2-replication_emIRT_only.pdf", ## RENAME
#   width = 4, height = 8, family = "Times")
# layout(matrix(1:2, 2, 1, byrow = TRUE))
# par(mar = c(2.5, 4, 2, 0.3) + 0.1, font.lab = 2)
# x <- (93:109)[-12]
