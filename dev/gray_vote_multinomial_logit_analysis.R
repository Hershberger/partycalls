...
flipflop_gray_model_0 <- multinom(coding ~ procedural + cq_votes,
  data = votedata103)
screenreg(flipflop_gray_model_0)

flipflop_gray_model_1 <- multinom(coding ~ close_votes + cq_votes,
  data = votedata103)
screenreg(flipflop_gray_model_1)

flipflop_gray_model_2 <- multinom(coding ~ procedural + close_votes,
  data = votedata103)
