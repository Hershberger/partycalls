...
mod1 <- felm(pfrate100 ~ ideological_extremism + vote_share +
...
mod2 <- felm(pfrate100 ~ ideological_extremism + vote_share +
  pres_vote_share + freshman + retiree + best_committee + up_for_reelection +
  power_committee + leader + chair | icpsrLegis + congress | 0 | icpsrLegis,
  senate_data[caucus == "Republican"])

mod3 <- felm(pfrate100 ~ ideological_extremism + vote_share +
  pres_vote_share + freshman + retiree + best_committee + up_for_reelection +
  power_committee + leader + chair | icpsrLegis + congress | 0 | icpsrLegis,
  senate_data[maj == 1])

mod4 <- felm(pfrate100 ~ ideological_extremism + vote_share +
  pres_vote_share + freshman + retiree + best_committee + up_for_reelection +
