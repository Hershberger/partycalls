...
x <- mean(new_whoheeds13$vote_share, na.rm = TRUE)
new_whoheeds13[is.na(vote_share) == TRUE,
  vote_share := x]
new_whoheeds13[, vote_share := vote_share - mean(vote_share)]
...
pdf(file="plots/who-heeds-figure2-replication_vote_share.pdf", ## RENAME
