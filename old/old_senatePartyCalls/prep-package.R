# 1. remove existing data + build package with functions only
# devtools::document()
# devtools::build()
# devtools::install()

# 2. load package + all external data
...
load("old_senatePartyCalls/old_data/senate_party_calls.rda")
...
# Populate freshman
freshman_dt <- fread("old_senatePartyCalls/inst/extdata/freshman_dt.csv")
...
leader_dt <- fread("old_senatePartyCalls/inst/extdata/leader_DT.csv")
...
committees_93102 <-
  read.delim("old_senatePartyCalls/inst/extdata/senate_assignments_80-102.txt",
  header = FALSE, sep = "\n")
committees_103112 <-
  gdata::read.xls("old_senatePartyCalls/inst/extdata/senate_assignments_103-11.xls")
...
source("old_senatePartyCalls/senate_seat_elections.R")
...
source("old_senatePartyCalls/fix_special_elections.R")
...
gingrich_senators <-
  fread("old_senatePartyCalls/inst/extdata/gingrich_senators.csv")
